        ...
        <div class="row">
            <div class="col-md-6 offset-md-3" style="background-color: white; padding: 20px; box-shadow: 10px 10px 5px #888;">
                ...
                <form action="show.php" method="get">
                    ...
                    <br>
                    <input type="text" autocomplete="off" class="form-control" name="first-name" style="border-radius: 0px; " placeholder="Text..." value="">
                    <br>
                    <input type="text" autocomplete="off" class="form-control" name="last-name" style="border-radius: 0px; " placeholder="Text..." value="">
                    <br>
